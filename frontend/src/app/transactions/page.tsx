                ...
                <div className="card">
                    <div className="form-group">
                        ...
                        <input
                            id="accountNo"
                            type="text"
                            placeholder="e.g. ACC-1740567890123-4821"
                            value={accountNo}
                        ...
                        <>
                            ...
                            <div className="result-card result-success">
                                ...
                                <div className="row">
                                    ...
                                    <span>{lastTx.type === "deposit" ? "+" : "-"}₹{lastTx.amount.toLocaleString()}</span>
                                </div>
                                <div className="row">
                                    <span>New Balance</span>
                                    <span className="balance-value">₹{result.balance.toLocaleString()}</span>
                                </div>
                            </div>
                        </>
                    )}
