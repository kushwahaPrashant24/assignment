        ...
        <>
            <style>{`
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .nav { display: flex; gap: 0.75rem; margin-bottom: 2.5rem; flex-wrap: wrap; justify-content: center; }
                ...
                .nav a:hover { color: #e2e8f0; border-color: rgba(255,255,255,0.25); }
                .nav a.active { background: rgba(167,139,250,0.15); border-color: #a78bfa; color: #a78bfa; }
                ...
                .btn-transfer:disabled { opacity: 0.55; cursor: not-allowed; transform: none; }
            ...
            <div className="page">
                ...
                <nav className="nav">
                    ...
                    <a href="/transfer" className="active">Transfer</a>
                </nav>
